...
const sampleCategories = [
  { id: "tv", name: "Televizyon", description: "OLED, QLED ve miniLED TV’ler", count: 48 },
  { id: "laptop", name: "Dizüstü Bilgisayar", description: "İnce ve güçlü ultrabook’lar", count: 63 },
  { id: "phone", name: "Akıllı Telefon", description: "Android ve iOS amiral gemileri", count: 72 },
  { id: "audio", name: "Ses Sistemleri", description: "Soundbar ve Hi-Fi hoparlörler", count: 31 },
];
        ...
        <section className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-2">
          {sampleCategories.map((category) => (
            <article key={category.id} className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              <p className="text-xs uppercase tracking-[0.3em] text-emerald-500">Kategori</p>
              ...
              <Link
                ...
                className="mt-6 inline-flex rounded-full border border-emerald-600 px-4 py-2 text-sm font-medium text-emerald-700 transition hover:bg-emerald-50"
              >
                Bu kategoride gezinin
              </Link>
            </article>
          ))}
        </section>
